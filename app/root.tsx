...
export function links() {
  return [
    { rel: "stylesheet", href:"https://rsms.me/inter/inter.css", as: "style", },
    { rel: "stylesheet", href:"/css/app.css", as: "style", }
  ];
}
        ...
        <main className="flex-grow flex flex-col justify-center max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex-shrink-0 flex justify-center">
            <a href="/" className="inline-flex">
              <span className="sr-only">Remix app</span>
          ...
          <div className="py-16">
            <div className="text-center">
              ...
              <p className="mt-2 text-base text-gray-500">Ooop!! Sorry can't find page!</p>
              <div className="mt-6">
